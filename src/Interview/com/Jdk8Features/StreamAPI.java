...
public class StreamAPI {
    public static void main(String[] args) {
        ...
        List<User> objectsSameAge = Arrays.asList(
                new User(12, "hua", 89),
                new User(12, "li2", 89),
        ...
        // filter 过滤 object中的值
        objects.stream().filter((s) -> s.getAge() > 100).forEach((a) -> System.out.println(a.getName()));
        ...
        objectsSameAge.stream().filter(param->param.getName()!="zhao1").limit(2).allMatch(param->param.getAge()==89);
